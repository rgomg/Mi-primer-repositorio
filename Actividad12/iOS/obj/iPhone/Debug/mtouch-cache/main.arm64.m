...
extern void *mono_aot_module_Actividad12_iOS_info;
...
{
	mono_aot_register_module (mono_aot_module_Actividad12_iOS_info);
...
void xamarin_register_assemblies ()
{
	...
	xamarin_open_and_register ("ZXing.Net.Mobile.dll");
...
void xamarin_setup ()
{
	...
	xamarin_executable_name = "Actividad12.iOS.exe";
