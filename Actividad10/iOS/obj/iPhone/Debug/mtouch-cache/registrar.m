...
int native_to_managed_trampoline_9 (id self, SEL _cmd, MonoMethod **managed_method_ptr, id p0, const char *r0, const char *r1, const char *r2)
{
	...
	xamarin_check_for_gced_object (mthis, _cmd, self, managed_method);
	arg_ptrs [0] = xamarin_get_inative_object_static (p0, false, "MonoTouch.UIKit.UIBarPositioningWrapper, monotouch, Version=0.0.0.0, Culture=neutral, PublicKeyToken=84e04ff9cfb79065", "MonoTouch.UIKit.IUIBarPositioning, monotouch, Version=0.0.0.0, Culture=neutral, PublicKeyToken=84e04ff9cfb79065");
...
@implementation AppDelegate { } 
	...
	{
		static MonoMethod *managed_method = NULL;
		return native_to_managed_trampoline_3 (self, _cmd, &managed_method, "Actividad10.iOS.AppDelegate, Actividad10iOS, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null", ".ctor");
	}
@end
...
@end
	...
	static MTClassMap __xamarin_class_map [] = {
		...
		{"AppDelegate", "Actividad10.iOS.AppDelegate, Actividad10iOS, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null", NULL },
...
void xamarin_create_classes () {
	...
	__xamarin_class_map [8].handle = objc_getClass ("MonoTouch_Foundation_InternalNSNotificationHandler");
	__xamarin_class_map [9].handle = objc_getClass ("NSValue");
	__xamarin_class_map [10].handle = objc_getClass ("NSNumber");
	...
	__xamarin_class_map [21].handle = objc_getClass ("UIResponder");
	...
	__xamarin_class_map [31].handle = objc_getClass ("MonoTouch_UIKit_UIControlEventProxy");
	...
	__xamarin_class_map [49].handle = objc_getClass ("NSIndexSet");
	__xamarin_class_map [50].handle = objc_getClass ("NSNotification");
	__xamarin_class_map [51].handle = objc_getClass ("GLKView");
	__xamarin_class_map [52].handle = objc_getClass ("EAGLContext");
	__xamarin_class_map [53].handle = objc_getClass ("NSTextAttachment");
	__xamarin_class_map [54].handle = objc_getClass ("UICollectionReusableView");
	__xamarin_class_map [55].handle = objc_getClass ("UICollectionViewCell");
	__xamarin_class_map [56].handle = objc_getClass ("UICollectionViewFlowLayout");
	__xamarin_class_map [57].handle = objc_getClass ("UITextPosition");
	__xamarin_class_map [58].handle = objc_getClass ("UITextRange");
	__xamarin_class_map [59].handle = objc_getClass ("UITextSelectionRect");
	...
	__xamarin_class_map [69].handle = objc_getClass ("UITabBar");
	__xamarin_class_map [70].handle = objc_getClass ("UITabBarController");
	...
	__xamarin_class_map [75].handle = objc_getClass ("UISplitViewController");
	...
	__xamarin_class_map [82].handle = objc_getClass ("MonoTouch_UIKit_UIActionSheet__UIActionSheetDelegate");
	__xamarin_class_map [83].handle = objc_getClass ("UIActionSheet");
	__xamarin_class_map [84].handle = objc_getClass ("MonoTouch_UIKit_UIAlertView__UIAlertViewDelegate");
	__xamarin_class_map [85].handle = objc_getClass ("UIAlertView");
	__xamarin_class_map [86].handle = objc_getClass ("MonoTouch_UIKit_UIBarButtonItem_Callback");
	...
	__xamarin_class_map [91].handle = objc_getClass ("MonoTouch_UIKit_UIGestureRecognizer__UIGestureRecognizerDelegate");
	__xamarin_class_map [92].handle = objc_getClass ("UIGestureRecognizer");
	__xamarin_class_map [93].handle = objc_getClass ("__UILongPressGestureRecognizer");
	__xamarin_class_map [94].handle = objc_getClass ("UILongPressGestureRecognizer");
	__xamarin_class_map [95].handle = objc_getClass ("__UITapGestureRecognizer");
	__xamarin_class_map [96].handle = objc_getClass ("UITapGestureRecognizer");
	...
	__xamarin_class_map [99].handle = objc_getClass ("MonoTouch_UIKit_UISearchBar__UISearchBarDelegate");
	__xamarin_class_map [100].handle = objc_getClass ("UISearchBar");
	__xamarin_class_map [101].handle = objc_getClass ("MonoTouch_UIKit_UITextField__UITextFieldDelegate");
	__xamarin_class_map [102].handle = objc_getClass ("UITextField");
	__xamarin_class_map [103].handle = objc_getClass ("MonoTouch_UIKit_UITextView__UITextViewDelegate");
	__xamarin_class_map [104].handle = objc_getClass ("UITextView");
	__xamarin_class_map [105].handle = objc_getClass ("MonoTouch_UIKit_UIScrollView__UIScrollViewDelegate");
	__xamarin_class_map [106].handle = [Xamarin_Forms_Platform_iOS_CellTableViewCell class];
	__xamarin_class_map [107].handle = [Xamarin_Forms_Platform_iOS_ViewRenderer class];
	__xamarin_class_map [108].handle = [Xamarin_Forms_Platform_iOS_NativeRenderer class];
	__xamarin_class_map [109].handle = [Xamarin_Forms_Platform_iOS_ModalWrapper class];
	__xamarin_class_map [110].handle = [Xamarin_Forms_Platform_iOS_PlatformRenderer class];
	__xamarin_class_map [111].handle = [Xamarin_Forms_Platform_iOS_ActivityIndicatorRenderer class];
	__xamarin_class_map [112].handle = [Xamarin_Forms_Platform_iOS_BoxRenderer class];
	__xamarin_class_map [113].handle = [Xamarin_Forms_Platform_iOS_NoCaretField class];
	__xamarin_class_map [114].handle = [Xamarin_Forms_Platform_iOS_EditorRenderer class];
	__xamarin_class_map [115].handle = [Xamarin_Forms_Platform_iOS_FrameRenderer class];
	__xamarin_class_map [116].handle = [Xamarin_Forms_Platform_iOS_LabelRenderer class];
	__xamarin_class_map [117].handle = [Xamarin_Forms_Platform_iOS_ProgressBarRenderer class];
	__xamarin_class_map [118].handle = [Xamarin_Forms_Platform_iOS_ScrollViewRenderer class];
	__xamarin_class_map [119].handle = [Xamarin_Forms_Platform_iOS_SliderRenderer class];
	__xamarin_class_map [120].handle = [Xamarin_Forms_Platform_iOS_StepperRenderer class];
	__xamarin_class_map [121].handle = [Xamarin_Forms_Platform_iOS_SwitchRenderer class];
	__xamarin_class_map [122].handle = [Xamarin_Forms_Platform_iOS_TabbedRenderer class];
	__xamarin_class_map [123].handle = [Xamarin_Forms_Platform_iOS_EventedViewController class];
	__xamarin_class_map [124].handle = objc_getClass ("UITableViewSource");
	__xamarin_class_map [125].handle = [Xamarin_Forms_Platform_iOS_TableViewModelRenderer class];
	__xamarin_class_map [126].handle = [Xamarin_Forms_Platform_iOS_UnEvenTableViewModelRenderer class];
	__xamarin_class_map [127].handle = [Xamarin_Forms_Platform_iOS_ToolbarRenderer class];
	__xamarin_class_map [128].handle = [Xamarin_Forms_Platform_iOS_EntryCellRenderer_EntryCellTableViewCell class];
	__xamarin_class_map [129].handle = [Xamarin_Forms_Platform_iOS_ViewCellRenderer_ViewTableCell class];
	__xamarin_class_map [130].handle = [Xamarin_Forms_Platform_iOS_ToolbarItemExtensions_SecondaryToolBarItem class];
	__xamarin_class_map [131].handle = [Xamarin_Forms_Platform_iOS_ButtonRenderer class];
	__xamarin_class_map [132].handle = [Xamarin_Forms_Platform_iOS_CarouselPageRenderer_PageContainer class];
	__xamarin_class_map [133].handle = [Xamarin_Forms_Platform_iOS_CarouselPageRenderer class];
	__xamarin_class_map [134].handle = [Xamarin_Forms_Platform_iOS_DatePickerRenderer class];
	__xamarin_class_map [135].handle = [Xamarin_Forms_Platform_iOS_EntryRenderer class];
	__xamarin_class_map [136].handle = [Xamarin_Forms_Platform_iOS_ImageRenderer class];
	__xamarin_class_map [137].handle = [Xamarin_Forms_Platform_iOS_ListViewRenderer_ListViewDataSource class];
	__xamarin_class_map [138].handle = [Xamarin_Forms_Platform_iOS_ListViewRenderer class];
	__xamarin_class_map [139].handle = [Xamarin_Forms_Platform_iOS_NavigationMenuRenderer_NavigationCell class];
	__xamarin_class_map [140].handle = [Xamarin_Forms_Platform_iOS_NavigationMenuRenderer_DataSource class];
	__xamarin_class_map [141].handle = [Xamarin_Forms_Platform_iOS_NavigationMenuRenderer_Delegate class];
	__xamarin_class_map [142].handle = [Xamarin_Forms_Platform_iOS_NavigationMenuRenderer class];
	__xamarin_class_map [143].handle = [Xamarin_Forms_Platform_iOS_NavigationRenderer_SecondaryToolbar class];
	__xamarin_class_map [144].handle = [Xamarin_Forms_Platform_iOS_NavigationRenderer_ParentingViewController class];
	__xamarin_class_map [145].handle = [Xamarin_Forms_Platform_iOS_NavigationRenderer class];
	__xamarin_class_map [146].handle = [Xamarin_Forms_Platform_iOS_OpenGLViewRenderer_Delegate class];
	__xamarin_class_map [147].handle = [Xamarin_Forms_Platform_iOS_OpenGLViewRenderer class];
	__xamarin_class_map [148].handle = [Xamarin_Forms_Platform_iOS_PageRenderer class];
	__xamarin_class_map [149].handle = [Xamarin_Forms_Platform_iOS_PhoneMasterDetailRenderer class];
	__xamarin_class_map [150].handle = [Xamarin_Forms_Platform_iOS_SearchBarRenderer class];
	__xamarin_class_map [151].handle = [Xamarin_Forms_Platform_iOS_TabletMasterDetailRenderer_InnerDelegate class];
	__xamarin_class_map [152].handle = [Xamarin_Forms_Platform_iOS_TabletMasterDetailRenderer class];
	__xamarin_class_map [153].handle = [Xamarin_Forms_Platform_iOS_TableViewRenderer class];
	__xamarin_class_map [154].handle = [Xamarin_Forms_Platform_iOS_TimePickerRenderer class];
	__xamarin_class_map [155].handle = [Xamarin_Forms_Platform_iOS_WebViewRenderer_CustomWebViewDelegate class];
	__xamarin_class_map [156].handle = [Xamarin_Forms_Platform_iOS_WebViewRenderer class];
	__xamarin_class_map [157].handle = [Xamarin_Forms_Platform_iOS_PickerRenderer_PickerSource class];
	__xamarin_class_map [158].handle = [Xamarin_Forms_Platform_iOS_PickerRenderer class];
